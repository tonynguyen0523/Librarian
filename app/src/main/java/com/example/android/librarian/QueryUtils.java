...
public class QueryUtils {
    ...
    public static List<Book> extractItemsFromJson(String bookJson) {
        ...
        //If JSON object is empty, return early
        if (TextUtils.isEmpty(bookJson)) {
            return null;
        }

        // Create an empty ArrayList so we can start adding book data to
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                String bookImageUrl = imageLinks.getString("smallThumbnail");
                ...
                Book book = new Book(bookImageUrl, title, author);
                books.add(book);
            }
